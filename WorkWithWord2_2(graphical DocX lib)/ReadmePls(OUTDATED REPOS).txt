...
Moreover, i should have done lot of things different, since i've learned smth from then, and a lot on new featers. This bring us to the last tesis of this text.
...
A also wanna learn WPF Framework, since it's much newer, recommended and uses Direct. I'm starting today to combine all this in a pretty simple base with nice graphics outputs and prints and same for input.
So, GL HF 4 me!)